...
run(" ", "mkdir /scripts/daniel/memz-files/")
run(" ", "cd /txt")
...
local response = read()
if response == "si" then
    run("Accediendo a la carpeta daniel", "cd daniel")
    run("Descargando programas 1", "wget https://raw.githubusercontent.com/danilacasito/class/ver1/scripts/daniel/help.lua")
    run("Descargando programas 2", "wget https://raw.githubusercontent.com/danilacasito/class/ver1/scripts/daniel/hola.lua")
    run("Descargando programas 3", "wget https://raw.githubusercontent.com/danilacasito/class/ver1/scripts/daniel/memz.lua")
    run("Descargando programas 4", "wget https://github.com/danilacasito/class/raw/ver1/scripts/daniel/nano.lua")
    run("Descargando programas 5", "wget https://github.com/danilacasito/class/raw/ver1/scripts/daniel/off.lua")
    run("Descargando programas 6", "wget https://github.com/danilacasito/class/raw/ver1/scripts/daniel/piedra.lua")
    run("Accediendo a la carpeta memz-files", "cd memz-files")
    run("Descargando programas 7", "wget https://github.com/danilacasito/class/raw/ver1/scripts/daniel/memz-files/booterror.nfp")
    run("Descargando programas 8", "wget https://github.com/danilacasito/class/raw/ver1/scripts/daniel/memz-files/startup.lua")
    print("Goodbye")
    os.reboot()
else
    os.reboot()
